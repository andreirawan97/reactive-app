...
export declare function setUpdatesConfig(config: ExpoConfig, expoPlist: ExpoPlist, username: string | null): {
    EXUpdatesEnabled: boolean;
    EXUpdatesURL: string | null;
    EXUpdatesCheckOnLaunch: string;
    EXUpdatesLaunchWaitMs: number;
    EXUpdatesReleaseChannel?: string | undefined;
    EXUpdatesRuntimeVersion?: string | undefined;
    EXUpdatesSDKVersion?: string | undefined;
};
